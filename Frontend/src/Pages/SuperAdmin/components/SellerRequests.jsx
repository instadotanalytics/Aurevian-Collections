        ...
        <div className={styles.actionButtons}>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (reason !== null) handleStatusChange(seller._id, 'rejected', reason);
            }}
            disabled={actionLoading === seller._id}
          >
            <FiX size={16} /> Reject
        ...
        <div className={styles.actionButtons}>
          <button
            ...
            onClick={() => {
              ...
              if (reason !== null) handleStatusChange(seller._id, 'suspended', reason);
            }}
            disabled={actionLoading === seller._id}
          >
    ...
    <div className={styles.sellerRequests}>
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>Manage seller registrations and approvals</p>
        </div>
                    ...
                    <td>
                      <div className={styles.sellerInfo}>
                        ...
                        <div>
                          ...
                          <div className={styles.sellerId}>ID: {seller._id.slice(-6)}</div>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div className={styles.contactInfo}>
                        <div><FiMail size={14} /> {seller.email}</div>
                        <div><FiPhone size={14} /> {seller.phone}</div>
                      </div>
                    </td>
                    <td>
                      <div className={styles.storeInfo}>
                        <strong>{seller.storeInfo?.storeName}</strong>
                        <span>{seller.productCategories?.join(', ') || 'No categories'}</span>
                      </div>
                    </td>
                    <td>
