...
const products = [
  { id: 1, badge: '30% off', category: 'Rings', name: 'Aurevian Solitaire Band', priceNow: '₹2,100', priceOld: '₹3,000', rating: 4.8 },
  { id: 2, badge: '20% off', category: 'Necklaces', name: 'Layla Layered Chain', priceNow: '₹3,400', priceOld: '₹4,250', rating: 4.6 },
  { id: 3, badge: '25% off', category: 'Earrings', name: 'Amara Drop Studs', priceNow: '₹1,650', priceOld: '₹2,200', rating: 5.0 },
  { id: 4, badge: '40% off', category: 'Bracelets', name: 'Celeste Charm Bracelet', priceNow: '₹1,800', priceOld: '₹3,000', rating: 4.9 },
  { id: 5, badge: '15% off', category: 'Rings', name: 'Noor Stack Ring Set', priceNow: '₹1,275', priceOld: '₹1,500', rating: 4.7 },
  { id: 6, badge: '50% off', category: 'Anklets', name: 'Meera Beaded Anklet', priceNow: '₹950', priceOld: '₹1,900', rating: 4.5 },
  { id: 7, badge: '10% off', category: 'Bridal Sets', name: 'Anaya Bridal Jewel Set', priceNow: '₹6,300', priceOld: '₹7,000', rating: 5.0 },
  { id: 8, badge: '35% off', category: 'Earrings', name: 'Zoya Hoop Earrings', priceNow: '₹1,300', priceOld: '₹2,000', rating: 4.9 },
  { id: 9, badge: '45% off', category: 'Necklaces', name: 'Ishani Pendant Chain', priceNow: '₹2,750', priceOld: '₹5,000', rating: 4.8 },
];

const perks = [
  { icon: '📦', title: 'Free Shipping', text: 'Free delivery for orders above ₹2,000' },
            ...
            {products.map((p) => (
              <div className={styles.productCard} key={p.id}>
                <div className={styles.productMedia}>
                  ...
                  {/* Replace the span below with your <img src="..." alt="..." /> */}
