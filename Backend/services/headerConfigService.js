...
// ============================================
// Default content — seeded once on first boot, mirrors the
// original static NavData.js so the storefront looks identical
...
const DEFAULT_CONFIG = {
  ...
  mainNav: [
    { id: "home", label: "Home", path: "/", hasDropdown: false, hasMegaMenu: false },
    { id: "shop", label: "Shop", path: "/shop", hasDropdown: false, hasMegaMenu: true },
    { id: "collections", label: "Collections", path: "/collections", hasDropdown: true, hasMegaMenu: false },
    { id: "new-arrivals", label: "Become a Partner", path: "/become-a-partner", hasDropdown: false, hasMegaMenu: false },
    { id: "gift-guide", label: "Gift Guide", path: "/gift-guide", hasDropdown: false, hasMegaMenu: true },
    { id: "offers", label: "Offers", path: "/offers", hasDropdown: true, hasMegaMenu: false },
    { id: "about", label: "About Us", path: "/about", hasDropdown: true, hasMegaMenu: false },
  ],
  shopMegaMenu: {
    categories: [
